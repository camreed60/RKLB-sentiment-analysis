...
# Load the dataset
df = pd.read_csv('data/clean_data/yfinance_data/cleaned_yfinance_data.csv')

# Extract columns
article_titles_col = df['Cleaned_Title']  # Title of the article
article_texts_col = df['Cleaned_Text']  # Cleaned text from the article
...
# Iterate through articles and calculate FinBERT sentiment
...
# Iterate through articles and calculate VADER sentiment
for title, text in zip(article_titles_col, article_texts_col):
